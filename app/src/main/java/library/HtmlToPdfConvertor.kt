...
/**
 * The Most of the code was collected from (open source repo) : https://github.com/mddanishansari/html-to-pdf-convertor
 * Collected date: 15-Jan-205
 * @author: Mehedi Hasan (Re-customizer)
 * */
